...
import type { CacheInfoThenable } from './segment-cache/cache-info-decoding'
...
export type CacheNodeSeedData = [
   ...
   */
  varyParams: CacheInfoThenable<VaryParams> | null,
]
...
export type InitialRSCPayload = {
   ...
   */
  h: CacheInfoThenable<VaryParams> | null
