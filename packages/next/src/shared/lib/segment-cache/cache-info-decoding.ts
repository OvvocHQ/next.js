 ...
 *
 * On the server, a CacheInfoThenable is created in a 'pending' state,
 ...
 */
export type CacheInfoThenable<T> = {
  status: string
  value: unknown
} & PromiseLike<T>

/**
 * Synchronously reads a value from a CacheInfoThenable.
 *
 ...
 */
export function readCacheInfo<T>(thenable: CacheInfoThenable<T>): T | null {
