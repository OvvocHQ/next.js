...
): CacheInfoThenable<VaryParams> | null {
  return accumulator as unknown as CacheInfoThenable<VaryParams> | null
}

export function getMetadataVaryParamsThenable(): CacheInfoThenable<VaryParams> | null {
